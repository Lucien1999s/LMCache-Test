...
def generate_once(
    ...
    old_request_phase = os.environ.get("CONTEXTFLOW_REQUEST_PHASE")
    os.environ["CONTEXTFLOW_REQUEST_PHASE"] = request_label
    try:
        with cf_span(
        ...
        if old_request_phase is None:
            os.environ.pop("CONTEXTFLOW_REQUEST_PHASE", None)
        else:
            os.environ["CONTEXTFLOW_REQUEST_PHASE"] = old_request_phase
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    try:
        ...
        with context as llm:
            ...
            output_text, generation_sec, output_tokens, generation_metrics = (
                generate_once(
                    llm,
                    measured_prompt,
                    args.max_new_tokens,
