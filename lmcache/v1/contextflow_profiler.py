...
class _NoOpTimer:
    """No-op timer used when ContextFlow profiling is disabled."""
    ...
    def finish(self, **metadata: Any) -> None:
        """Finish without recording an event."""
        return
...
def record_event(
    ...
    *,
    ...
    event = {
        ...
        "request_phase": os.environ.get("CONTEXTFLOW_REQUEST_PHASE"),
        "condition": _condition(),
        "gpu_memory_mb": (
            gpu_memory_mb if gpu_memory_mb is not None else _gpu_memory_mb()
        ),
